...
nhn.husky.SE_QuickEditor_Image = jindo.$Class({
    ...
    _panelReSetting : function(){
        ...
        this.elPanelImgWidth.value = (parseInt(elImage.style.width, 10) || 50);
        this.elPanelImgHeight.value = (parseInt(elImage.style.height, 10) || 50);
    ...
    $ON_IMG_QE_RESET_PALETTE : function(weEvent){
        ...
        if(!!elTemp){
            ...
            this.welElement.css("borderWidth", elTemp.border+"em");
    ...
    _resizeImage : function(elEvent){
        ...
        var nImgBeforeWidth = (parseInt(elImage.style.rwidth, 10) || 50);
        var nImgBeforeHeight = (parseInt(elImage.style.rheight, 10) || 50);
    ...
    $ON_IMG_QE_SET_BORDER : function(nBorderSize){  // border size
        this.welElement.css("borderWidth", nBorderSize / 16 + "em");
        this.welElement.css("borderStyle", "solid");
